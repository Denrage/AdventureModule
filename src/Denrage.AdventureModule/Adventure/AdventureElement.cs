...
{
    public abstract class AdventureElement
    {
    ...
    public class AdventureScript
    {
        ...
        private object CreateCuboid(string name, Vector3 position, Vector3 dimension)
        {
        ...
        private object GetCuboid(string name)
        {
        ...
        public AdventureScript()
        {
            ...
            debugServer.AttachToScript(script, "test");
            script.Globals["createCuboid"] = (Func<string, Vector3, Vector3, object>)this.CreateCuboid;
            script.Globals["Vector3"] = typeof(Vector3);
            script.DoFile(@"D:\Repos\AdventureModule\test.lua");
        }
    }
