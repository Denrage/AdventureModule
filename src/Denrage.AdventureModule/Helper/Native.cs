...
namespace Denrage.AdventureModule.Helper
{
    public static class Native
    {
        ...
        /// </remarks>
        [DllImport(AsyncWindowsClipboard.Clipboard.Native.Dlls.Kernel32)]
        ...
        [DllImport(AsyncWindowsClipboard.Clipboard.Native.Dlls.Kernel32, SetLastError = true)]
        ...
        [DllImport(AsyncWindowsClipboard.Clipboard.Native.Dlls.User32, SetLastError = true)]
        ...
        /// <seealso cref="EmptyClipboard" />
        /// <seealso cref="SetClipboardData" />
        [DllImport(AsyncWindowsClipboard.Clipboard.Native.Dlls.User32)]
        [return: MarshalAs(UnmanagedType.Bool)]
